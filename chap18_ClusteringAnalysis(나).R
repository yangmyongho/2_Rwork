...
install.packages("cluster") # hclust() : <Hierarchical clust>계층적 클러스터 함수 제공
...
head(iris_matrix)
dim(iris_matrix) # 150 4

nc <- NbClust(iris_matrix, distance = "euclidean",min.nc = 2,
              max.nc = 15, method = "complete")
nc
names(nc) # "All.index"  "All.CriticalValues"  "Best.nc"  "Best.partition"  
table(nc$Best.nc[1,])
