...
# 기술통계량
summary(product) # 요약통계량 <전부 1 ~ 5 점 척도 > 
...
cor(score_iq[-1]) # score 기준 iq(0.88222034) 과 academy(0.8962647) 거의 비슷
cov(score_iq[-1]) # 51.3375391  7.1199105
# cov에서 - 는 방향이 아닌 실제 숫자의 크기 부호일뿐이다.
