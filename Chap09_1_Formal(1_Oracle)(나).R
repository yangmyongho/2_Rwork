...
#install.packages("rJava") # 이미 설치되어있으므로
install.packages("DBI")
install.packages("RJDBC")

# 2. 패키지 로딩
library(DBI) # 의존성이없어서 제일먼저 로딩
Sys.setenv(JAVA_HOME='C:\\Program Files\\Java\\jre1.8.0_151') # 수정함
library(rJava)
...
# 문제1) SAL 2500 이상이고, 직책(JOB)이 MANAGER인 사원만 검색하기
